...
describe('Test Camera Page', () => {
  beforeEach(() => {
    ...
    cy.wait(15000).visit(Cypress.env('host') + '/warning');
  });
  ...
  describe('Test FunctionalContainer', () => {
    ...
    it(`TC${testCaseID += 1} - FunctionalContainer should have icon "setting"`, () => {
      cy.get('[class^=WarningPage_FunctionalContainer__]').find('img').last().should('have.attr', 'src')
    ...
    it(`TC${testCaseID += 1} - FunctionalContainer have text "Cài đặt cảnh báo"`, () => {
      cy.get('[class^=WarningPage_FunctionalContainer__]').contains('Cài đặt cảnh báo');
    });
    it(`TC${testCaseID += 1} - FunctionalContainer should have css font-family: Mulish`, () => {
      cy.get('[class^=WarningPage_FunctionalContainer__]').should('have.css', 'font-family', 'Mulish, sans-serif');
    });
